...
void Read0_initialize(boolean_T firstTime)
{
  ...
  rtmSetTFinal(Read0_M, 10.0);
  Read0_M->Timing.stepSize0 = 0.001;

  /* external mode info */
  Read0_M->Sizes.checksums[0] = (2128476792U);
  Read0_M->Sizes.checksums[1] = (3618054825U);
  Read0_M->Sizes.checksums[2] = (1830599092U);
  Read0_M->Sizes.checksums[3] = (2743026692U);
