...
void Read_data_optimal_initialize(boolean_T firstTime)
{
  ...
  rtmSetTFinal(Read_data_optimal_M, 5.0);
  Read_data_optimal_M->Timing.stepSize0 = 0.001;

  /* external mode info */
  Read_data_optimal_M->Sizes.checksums[0] = (2952078772U);
  Read_data_optimal_M->Sizes.checksums[1] = (1519560431U);
  Read_data_optimal_M->Sizes.checksums[2] = (3211499298U);
  Read_data_optimal_M->Sizes.checksums[3] = (1554499231U);
