...
void ReadL_output(int_T tid)
{
  ...
  /* S-Function Block: ReadL/HIL Read Analog (hil_read_analog_block) */
  {
    ...
    ReadL_B.HILReadAnalog = ReadL_DWork.HILReadAnalog_Buffer;
  }
  ...
  /* S-Function Block: ReadL/HIL Read Analog1 (hil_read_analog_block) */
  {
    ...
    ReadL_B.HILReadAnalog1 = ReadL_DWork.HILReadAnalog1_Buffer;
  }
...
void ReadL_initialize(boolean_T firstTime)
{
  ...
  rtmSetTFinal(ReadL_M, 10.0);
  ReadL_M->Timing.stepSize0 = 0.001;

  /* external mode info */
  ReadL_M->Sizes.checksums[0] = (1033130269U);
  ReadL_M->Sizes.checksums[1] = (334944125U);
  ReadL_M->Sizes.checksums[2] = (1972218596U);
  ReadL_M->Sizes.checksums[3] = (1278356403U);
  ...
  /* block I/O */
  ReadL_M->ModelData.blockIO = ((void *) &ReadL_B);
  (void) memset(((void *) &ReadL_B), 0,
                sizeof(BlockIO_ReadL));
...
void MdlInitializeSizes(void)
{
  ...
  ReadL_M->Sizes.numBlocks = (7);      /* Number of blocks */
  ReadL_M->Sizes.numBlockIO = (2);     /* Number of block outputs */
