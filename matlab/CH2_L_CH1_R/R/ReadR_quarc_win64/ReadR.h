 ...
 * C source code generated on : Thu Sep 10 15:26:48 2020
 *
 ...
 */
#ifndef RTW_HEADER_ReadR_h_
#define RTW_HEADER_ReadR_h_
#ifndef ReadR_COMMON_INCLUDES_
# define ReadR_COMMON_INCLUDES_
#include <stdio.h>
#include <stddef.h>
#include <string.h>
#include "rtwtypes.h"
...
#define ReadR_rtModel                  RT_MODEL_ReadR
...
#define rtB                            ReadR_B
#define BlockIO                        BlockIO_ReadR
#define rtXdot                         ReadR_Xdot
#define StateDerivatives               StateDerivatives_ReadR
#define tXdis                          ReadR_Xdis
#define StateDisabled                  StateDisabled_ReadR
#define rtP                            ReadR_P
#define Parameters                     Parameters_ReadR
#define rtDWork                        ReadR_DWork
#define D_Work                         D_Work_ReadR

/* Parameters (auto storage) */
struct Parameters_ReadR_ {
...
extern Parameters_ReadR ReadR_P;

/* Block signals (auto storage) */
extern BlockIO_ReadR ReadR_B;

/* Block states (auto storage) */
extern D_Work_ReadR ReadR_DWork;

/* Model entry point functions */
extern void ReadR_initialize(boolean_T firstTime);
extern void ReadR_output(int_T tid);
extern void ReadR_update(int_T tid);
extern void ReadR_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_ReadR *const ReadR_M;
