...
void Read_data_bimanul_output(int_T tid)
{
    ...
    if (fp != (NULL)) {
      ...
      if (fwrite(u, sizeof(real_T), 2, fp) != 2) {
        rtmSetErrorStatus(Read_data_bimanul_M,
                          "Error writing to MAT-file static01ch0.mat");
        return;
      }
      ...
      if (((++Read_data_bimanul_DWork.ToFile_IWORK.Count)*2)+1 >= 100000000) {
        (void)fprintf(stdout,
                      ...
                      "    allowed in MAT-file static01ch0.mat.\n");
      }
    }
  }
  ...
  if (!(++Read_data_bimanul_DWork.ToFile1_IWORK.Decimation % 1) &&
    ...
    if (fp != (NULL)) {
      ...
      if (fwrite(u, sizeof(real_T), 2, fp) != 2) {
        rtmSetErrorStatus(Read_data_bimanul_M,
                          "Error writing to MAT-file static01ch1.mat");
        return;
      }
      ...
      if (((++Read_data_bimanul_DWork.ToFile1_IWORK.Count)*2)+1 >= 100000000) {
        (void)fprintf(stdout,
                      ...
                      "    the simulation has ended, because it has reached\n"
                      "    the maximum number of elements (100000000)\n"
                      "    allowed in MAT-file static01ch1.mat.\n");
      }
    }
  }
...
void Read_data_bimanul_initialize(boolean_T firstTime)
{
  ...
  /* external mode info */
  Read_data_bimanul_M->Sizes.checksums[0] = (3596662759U);
  Read_data_bimanul_M->Sizes.checksums[1] = (1532257136U);
  Read_data_bimanul_M->Sizes.checksums[2] = (4233145325U);
  Read_data_bimanul_M->Sizes.checksums[3] = (749773192U);
...
void Read_data_bimanul_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    FILE *fp = (FILE *) Read_data_bimanul_DWork.ToFile_PWORK.FilePtr;
    if (fp != (NULL)) {
      char fileName[509] = "static01ch0.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(Read_data_bimanul_M,
                          "Error closing MAT-file static01ch0.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(Read_data_bimanul_M,
                          "Error reopening MAT-file static01ch0.mat");
        return;
      }
      ...
      if (rt_WriteMat4FileHeader(fp, 2,
        ...
        rtmSetErrorStatus(Read_data_bimanul_M,
                          "Error writing header for ch0 to MAT-file static01ch0.mat");
      }
  ...
  /* Terminate for ToFile: '<Root>/To File1' */
  {
    FILE *fp = (FILE *) Read_data_bimanul_DWork.ToFile1_PWORK.FilePtr;
    if (fp != (NULL)) {
      char fileName[509] = "static01ch1.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(Read_data_bimanul_M,
                          "Error closing MAT-file static01ch1.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(Read_data_bimanul_M,
                          "Error reopening MAT-file static01ch1.mat");
        return;
      }
      ...
      if (rt_WriteMat4FileHeader(fp, 2,
        ...
        rtmSetErrorStatus(Read_data_bimanul_M,
                          "Error writing header for ch1 to MAT-file static01ch1.mat");
      }
...
void MdlStart(void)
{
  ...
  /* Start for ToFile: '<Root>/To File' */
  {
    ...
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(Read_data_bimanul_M,
                        "Error creating .mat file static01ch0.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,2,0,"ch0")) {
      rtmSetErrorStatus(Read_data_bimanul_M,
                        "Error writing mat file header to file static01ch0.mat");
      return;
    }
  ...
  /* Start for ToFile: '<Root>/To File1' */
  {
    ...
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(Read_data_bimanul_M,
                        "Error creating .mat file static01ch1.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,2,0,"ch1")) {
      rtmSetErrorStatus(Read_data_bimanul_M,
                        "Error writing mat file header to file static01ch1.mat");
      return;
    }
